...
class LogToDask(Converter):
    ...
    def create_dataframe(self, log_filename: str, ts_index: bool = True, aggressive_category: bool = True, usecols:Optional[List[str]] = None) -> dd.DataFrame:
        ...
        self._df = self._get_dataframe(log_filename=log_filename, all_fields=all_fields, dtypes=dask_types, usecols=usecols)
    ...
    def _get_dataframe(self, log_filename: str, all_fields: List[str], dtypes: Dict, usecols: Optional[List[str]]) -> dd.DataFrame:
    ...
    def _apply_type_map(self, column_names: List[str], column_types: List[str], aggressive_category: bool = True, verbose: bool = False) -> Tuple[List[str], List[str]]:
