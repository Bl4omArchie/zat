...
class LogToDataFrame():
    ...
    def create_dataframe(self, log_filename: str, ts_index: bool = True, aggressive_category: bool = True, usecols:Optional[List[str]] = None) -> pd.DataFrame:
        ...
        self._df = self._get_dataframe(log_filename=log_filename, all_fields=all_fields, usecols=usecols, dtypes=type_map)
    ...
    def _get_dataframe(self, log_filename: str, all_fields: List[str], dtypes: Dict, usecols: Optional[List[str]]) -> pd.DataFrame:
